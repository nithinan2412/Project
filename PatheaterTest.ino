// ยังไม่สามารถทำOTAในบอร์ดmegaได้เพราะต้องทำการเบิร์นบอร์ดก่อนใช้และตัวโค้ดOTA ของ megaนั้นยังไม่ตายตัว อ้งอิงจาก : https://github.com/jandrassy/ArduinoOTA#atmega-support
